...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            print()
            choice = Functions.get_input(f"{Fore.CYAN}[=]{Col.gray} Enter Your Choice: {Col.green}",
                                         lambda x: x in [str(i) for i in choices])
            ...
            count = Functions.get_input(f"{Fore.CYAN}[=]{Col.gray} Enter spam count: {Col.green}",
